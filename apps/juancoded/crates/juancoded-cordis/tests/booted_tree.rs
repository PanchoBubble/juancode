...
const DUMP: &str = "\
juancoded config: 7 entries (6 active, 1 pending, 0 disabled, 0 failed), 2 services, 5 events, 3 contributions
...
└─ [ACTIVE  ] pr-notify-filter  pr-notify-filter  effects=1
...
events
├─ pr.notify            around   1  pr-notify.desktop-rules
