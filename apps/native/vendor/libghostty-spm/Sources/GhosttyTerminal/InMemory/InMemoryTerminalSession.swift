...
public final class InMemoryTerminalSession: @unchecked Sendable {
    ...
    /// juancode patch (juancode-o9h2): true once a write has been abandoned as wedged
    /// inside libghostty. Its surface must be leaked, not freed — the stalled call may
    /// still touch it. Read by `TerminalSurfaceCoordinator.tearDownSurface`.
    var hasStalledOperations: Bool {
        surfaceAccess.hasStalledOperations
    }
